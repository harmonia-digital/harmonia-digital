...
### Consultor IA · Automatització · Sistemes Multi-Agent · Mobile & SaaS Developer

Construeixo solucions d'intel·ligència artificial, aplicacions mòbils i productes SaaS que automatitzen processos, optimitzen operacions i resolen problemes reals de negoci.

**Fundador de [Harmonia Digital](https://www.harmoniadigitalweb.com)**
...
Ajudo a empreses a incorporar la IA de forma pràctica: des d'assistents intel·ligents i automatitzacions fins a sistemes multi-agent i productes digitables complets.

| Àrea | Què faig |
|---|---|
| 🤖 Sistemes Multi-Agent | Arquitectures amb LangGraph per a fluxos d'IA complexos |
| 🧠 Assistents Intel·ligents | IA conversacional per a diferents sectors |
| ⚡ Automatització | Reducció de tasques repetitives amb IA i integracions |
| 📱 Apps Mòbils | Flutter per a Android i iOS |
| 🏗️ Productes SaaS | Des de la idea fins al deploy, impulsats per IA |
| 📈 Transformació Digital | Acompanyament complet en adopció d'IA |
...
Plataforma SaaS d'analítica per a la Lliga Catalana de Pàdel.

- Sync automàtic de dades de competició (200 grups, 13.500 jugadors)
- Ranking de jugadors, classificacions, calendaris i actes detallades
- Assistent IA amb tool calling per consultes en llenguatge natural
...
- Extracció de riscos legals, condicions financeres i oportunitats
...
- Roadmap d'adopció d'IA personalitzat
...
> Crec que la IA ha de servir per simplificar el treball de les persones i ajudar les empreses a ser més eficients, competitives i innovadores.

M'agrada construir productes complets: des de la idea inicial fins a la publicació i evolució, combinant intel·ligència artificial, automatització i desenvolupament de software.
...
<p align="center">
  ...
  <a href="https://www.harmoniadigitalweb.com"><img src="https://img.shields.io/badge/Web-Harmonia_Digital-000?logo=googlechrome&logoColor=white" alt="Web" /></a>
  <a href="mailto:admin@harmoniadigitalweb.com"><img src="https://img.shields.io/badge/Email-admin@harmoniadigitalweb.com-EA4335?logo=gmail&logoColor=white" alt="Email" /></a>
</p>
...
⭐ Si t'interessen la IA, l'automatització i el desenvolupament de productes tecnològics, estaré encantat de connectar.
